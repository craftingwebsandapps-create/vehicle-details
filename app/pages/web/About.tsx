const principles = [
  ...
  "Protected mobile routes rely on a reusable auth helper and redirect callbacks.",
  "TanStack Query centralizes data fetching and mutation state for scalable features.",
]
    ...
    <div className="grid w-full gap-6 lg:grid-cols-[0.9fr_1.1fr]">
      <section className="rounded-[32px] border border-border/60 bg-foreground px-6 py-8 text-background shadow-[0_20px_60px_-30px_rgba(15,23,42,0.55)] sm:px-8">
        ...
        <p className="mt-4 text-sm leading-7 text-primary-foreground/80">
          The web layout handles discovery and marketing journeys. The mobile
          layout behaves like a focused application shell with protected pages
          and persistent bottom tabs.
        </p>
      </section>
