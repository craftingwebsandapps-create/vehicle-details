    ...
    <div className="grid w-full gap-6 lg:grid-cols-[0.95fr_1.05fr]">
      ...
      <section className="rounded-[32px] border border-border/60 bg-background/90 p-6 shadow-[0_18px_48px_-34px_rgba(15,23,42,0.35)] sm:p-8">
        <div className="grid gap-5">
          ...
          <textarea
            className="min-h-32 rounded-2xl border border-input bg-transparent px-4 py-3 text-sm transition-colors outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
